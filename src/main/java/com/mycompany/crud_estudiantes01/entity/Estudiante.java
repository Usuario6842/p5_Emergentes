...
@NamedQueries({
    ...
    @NamedQuery(name = "Estudiante.findByFNacimiento", query = "SELECT e FROM Estudiante e WHERE e.fNacimiento = :fNacimiento")})
public class Estudiante implements Serializable {
    ...
    public String toString() {
        return "Estudiante{" + "id=" + id + ", nombre=" + nombre + ", apellido=" + apellido + ", email=" + email + ", fNacimiento=" + fNacimiento + '}';
    }
